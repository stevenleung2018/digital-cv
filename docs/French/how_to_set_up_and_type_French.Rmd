...
-   In this file, I explain how to type French letters and punctuations on computers which are equipped with US English keyboards.
-   It is based on the fact that I am primarily an anglophone learning French. In order words, I will minimize the learning required to be able to type French. There is no need to learn any new keyboard layout (like Azerty in France or CSA in Canada). The focus will be on how to type the "extra" French things that is not usually required when typing English.\
...
-   It is the simplest. You just need to make sure that you have an input method as "English" and the keyboard layout is "US English". The icon is a single capital letter "A". This may already have been the default setting on your Mac. \### Typing
...
## iPhone (iOS 17) and iPad (iPadOS 17)

### Setup
- Settings -> General -> Keyboard -> Keyboards -> Add New Keyboard
- Type `French` and choose the variation of French you want (e.g. French (France), French (Canada)).  (Choosing a different variation here does not affect how you type.  It will affect the spell checking and autocomplete functionalities.)
